...
import (
	"OpenCNC/tsn_service/pkg/resource_allocation_entity/dataStructures/SchemaTreeMethods"
	"OpenCNC/tsn_service/pkg/resource_allocation_entity/dataStructures/composit"
	"fmt"
