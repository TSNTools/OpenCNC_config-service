...
async function loadView(screen) {
  switch (screen) {
    case "dashboard":
      ...
      break;
    case "device-models":
      await Promise.all([loadDeviceModels(), loadRecentEvents()]);
      break;
    case "nodes":
      await Promise.all([loadNodes(), loadRecentEvents()]);
      break;
    case "links":
      await Promise.all([loadLinks(), loadRecentEvents()]);
      break;
    case "streams":
      await Promise.all([loadStreams(), loadRecentEvents()]);
      break;
    case "logs":
      await loadLogs();
      break;
