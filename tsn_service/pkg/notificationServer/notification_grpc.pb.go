...
type NotificationClient interface {
	...
	Notify(ctx context.Context, in *Event, opts ...grpc.CallOption) (*NotifyResponse, error)
}
...
func (c *notificationClient) Notify(ctx context.Context, in *Event, opts ...grpc.CallOption) (*NotifyResponse, error) {
...
type NotificationServer interface {
	// Single intake point for notifications from other OpenCNC services.
	Notify(context.Context, *Event) (*NotifyResponse, error)
...
func (UnimplementedNotificationServer) Notify(context.Context, *Event) (*NotifyResponse, error) {
