...
type BridgeMstConfig struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	SupportedMstIds    []uint32               `protobuf:"varint,1,rep,packed,name=supported_mst_ids,json=supportedMstIds,proto3" json:"supported_mst_ids,omitempty"`
...
const file_common_structures_stp_stp_proto_rawDesc = "" +
	...
	"\f_stp_enabled\"\xe1\x01\n" +
	"\x0fBridgeMstConfig\x12*\n" +
	"\x11supported_mst_ids\x18\x01 \x03(\rR\x0fsupportedMstIds\x12I\n" +
	"\x15fid_to_mstid_mappings\x18\x02 \x03(\v2\x16.stp.FidToMstidMappingR\x12fidToMstidMappings\x12W\n" +
	"\x18fid_to_mstid_allocations\x18\x03 \x03(\v2\x1e.stp.FidRangeToMstidAllocationR\x15fidToMstidAllocations\"<\n" +
	...
	"\x06mst_id\x18\x02 \x01(\rR\x05mstId\"\x91\x01\n" +
...
var file_common_structures_stp_stp_proto_goTypes = []any{
	...
	(*BridgeMstConfig)(nil),           // 3: stp.BridgeMstConfig
	(*FidToMstidMapping)(nil),         // 4: stp.FidToMstidMapping
	(*FidRangeToMstidAllocation)(nil), // 5: stp.FidRangeToMstidAllocation
...
var file_common_structures_stp_stp_proto_depIdxs = []int32{
	...
	7, // 3: stp.SpanningTreeInstance.port_states:type_name -> stp.StpPortState
	0, // 4: stp.StpPortState.role:type_name -> stp.PortRole
	1, // 5: stp.StpPortState.state:type_name -> stp.PortState
