...
type Node struct {
	...
	NodeConfigId   *string                `protobuf:"bytes,8,opt,name=node_config_id,json=nodeConfigId,proto3,oneof" json:"node_config_id,omitempty"` // refernce to the configuration applied to this node
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *Node) GetNodeConfigId() string {
	if x != nil && x.NodeConfigId != nil {
		return *x.NodeConfigId
	}
	return ""
}
...
const file_pkg_structures_topology_topology_proto_rawDesc = "" +
	"\n" +
	"&pkg/structures/topology/topology.proto\x12\btopology\"\x81\x01\n" +
	"\bTopology\x12$\n" +
	...
	"properties\x12)\n" +
	"\x0enode_config_id\x18\b \x01(\tH\x00R\fnodeConfigId\x88\x01\x01B\x11\n" +
	"\x0f_node_config_id\"\x9e\x02\n" +
